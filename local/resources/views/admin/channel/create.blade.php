    ...
    <div class="sales-report-area  mb-5">
        <div class="row">
        	<div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Create A Channel</h4>
                        <p class="text-muted font-14 mb-4">Add detail to Channel</p>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="start_date" type="datetime-local" value="{{old('start_date')}}" id="datetimepicker1">
                            <div class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="end_date" type="datetime-local" value="{{old('end_date')}}" id="datetimepicker2">
                            <div class="text-danger">
