        	...
        	<div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-14 mb-4">Add detail to Customer</p>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="name" type="text" value="{{$customer->name}}" id="example-name-input">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="email" type="email" value="{{$customer->email}}" id="example-email-input">
                            <div class="text-danger">
                                @if ($errors->has('email'))
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text"  name="address" value="{{$customer->address}}" id="example-address-input">
                            <div class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" data-role="tagsinput" name="phone" type="text" value="{{$customer->phone}}" id="example-phone-input" placeholder="98xxxxxxxxx, 98xxxxxxxxxxx,">
                            <div class="text-danger">
                                @if ($errors->has('phone'))
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            @if($customer->image)
                            <img src="{{asset('/images/'.$customer->image)}}" alt="customer image" width="100px;">
                            @endif
                            <div class="text-danger">
                                @if ($errors->has('image'))
                                    <span class="text-danger" role="alert">
