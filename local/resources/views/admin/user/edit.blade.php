                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text"  name="address" value="{{$user->address}}" id="example-address-input">
                            <div class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" data-role="tagsinput" name="phone" type="text" value="{{$user->phone}}" id="example-phone-input" placeholder="98xxxxxxxxx, 98xxxxxxxxxxx,">
                            <div class="text-danger">
                                @if ($errors->has('phone'))
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            @if($user->image)
                            <img src="{{asset('/images/'.$user->image)}}" alt="user image" width="100px;">
                            @endif
                            <div class="text-danger">
                                @if ($errors->has('image'))
                                    <span class="text-danger" role="alert">
