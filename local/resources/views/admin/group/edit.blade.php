    ...
    <div class="sales-report-area  mb-5">
        <div class="row">
        	<div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Edit A Group</h4>
                        <p class="text-muted font-14 mb-4">Edit detail to Group</p>
                        <form method="post" action="{{route('group.update', $data['group']->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        
                        <div class="form-group">
                            <label for="example-text-input" class="col-form-label required">Title</label>
                            <input class="form-control" name="title" type="text" value="{{$data['group']->title}}" id="example-title-input">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="slug" type="text" value="{{$data['group']->slug}}" id="example-slug-input">
                            <div class="text-danger">
                                @if ($errors->has('slug'))
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="order" type="text" value="{{$data['group']->order}}" id="example-order-input">
                            <div class="text-danger">
                                @if ($errors->has('order'))
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="description" rows="10" max="200">{{$data['group']->description}}</textarea>
                            <div class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            @if($data['group']->image)
                                <img src="{{asset('images/'.$data['group']->image)}}" width="100px">
                            @endif
                            <div class="text-danger">
                                @if ($errors->has('image'))
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            @if(in_array($category->id, $data['items']))
                            <input name="category[]" type="checkbox" value="{{$category->id}}" checked> {{$category->title}}
                            @else
