    ...
    <div class="sales-report-area mb-5">
        <div class="row">
        	<div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <a href="{{route('category.create')}}" class="btn btn-xs btn-primary pull-right"><i class="ti-plus"></i> Add New</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img src="{{asset('/images/'.$category->image)}}" alt="category image" width="100px;">
                                            @endif
                                        </td>     
                                        <td>
										...
										<td>
											<form method="post" action="{{route('category.destroy', $category->id)}}">
												...
												<a href="{{route('category.edit', $category->id)}}" class="btn btn-xs btn-warning"><i class="ti-pencil-alt"></i></a>
