        	...
        	<div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-14 mb-4">Add detail to Blog</p>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="title" type="text" value="{{$blog->title}}" id="example-title-input">
                        ...
                        <div class="form-group">
                            <label for="example-email-input" class="col-form-label">Seo Url</label>
                            <input class="form-control" name="slug" type="slug" value="{{$blog->slug}}" id="example-slug-input">
                            <div class="text-danger">
                                @if ($errors->has('slug'))
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="form-group">
                            <label for="example-tags-input" class="col-form-label">Tags</label>
                            <input class="form-control" data-role="tagsinput" name="tags" type="tags" value="{{$blog->tags}}" id="example-tags-input">
                            <div class="text-danger">
                                @if ($errors->has('tags'))
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="description" rows="10">{{$blog->description}}</textarea>
                            <div class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            @if($blog->image)
                                <img src="{{asset('images/'.$blog->image)}}" alt="blog image" width="100px;">
                            @endif
                            <div class="text-danger">
                                @if ($errors->has('image'))
                                    <span class="text-danger" role="alert">
